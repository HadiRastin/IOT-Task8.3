...
client.on('connect', function () {
  ...
  setInterval(() => {
    ...
    client.publish('/drones/ShortDistanceDrone/Battery', message);
  ...
  setInterval(() => {
      ...
      client.publish('/drones/ShortDistanceDrone/LatLong', message);
  ...
  setInterval(() => {
    ...
    client.publish('/drones/ShortDistanceDrone/Altitude', message);
  ...
  setInterval(() => {
    ...
    client.publish('/drones/ShortDistanceDrone/Speed', message);
